...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/chrisbowles-sarc-org/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>chrisbowles-sarc-org</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>chrisbowles-sarc-org</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/chrisbowles-sarc-org/pipeline-template-catalog.git</repositoryUrl>
              <traits>
